        ...
        <div className={styles.settingsCard}>
          <section className={styles.inputsImgSection}>
            ...
            <ul className={styles.inputUl}>
              ...
              <li>
                <div className={styles.detailsDiv}>Short Description</div>
                <input
          ...
          <section className={styles.buttonSection}>
            <button className={styles.buttonStyle} onClick={() => saveEdits()}>Save Changes</button>
          </section>
        </div>
      </main>
